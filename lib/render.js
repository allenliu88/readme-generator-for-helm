...
function insertReadmeTable(readmeFilePath, sections, config) {
  ...
  if (paramsSectionLimits.length === 1) {
    ...
    // Delete by allen.liu @2023-05-16 仅仅寻找【## Parameters】到【## Others】之间位置插入
  ...
  console.log(`INFO: Deleting ${paramsSectionLimits[1] - paramsSectionLimits[0] - 1} lines at line ${paramsSectionLimits[0] + 1}`)
  // Altered by allen.liu @2023-05-16 还需要在原来基础上再-1才可以
  lines.splice(paramsSectionLimits[0] + 1, paramsSectionLimits[1] - paramsSectionLimits[0] - 1);
